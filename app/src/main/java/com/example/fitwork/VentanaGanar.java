...
public class VentanaGanar extends AppCompatActivity {
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (listaMusculos.get(rvMuscles.getChildAdapterPosition(view)).getNombre() == "Dieta 1") {
                    Intent intent = new Intent(getApplicationContext(), VentanaDietaGanar1.class);
                    startActivity(intent);
                }

                else if (listaMusculos.get(rvMuscles.getChildAdapterPosition(view)).getNombre() == "Dieta 2") {
                    Intent intent = new Intent(getApplicationContext(), VentanaDietaGanar2.class);
                    startActivity(intent);
                }
            }
        });
    ...
    private void llenarDatosMusculos() {
        ...
        listaMusculos.add(new guiaEjercicios("Dieta 1", "", R.drawable.ganar_masa));
        listaMusculos.add(new guiaEjercicios("Dieta 2", "",R.drawable.ganar_masa));
